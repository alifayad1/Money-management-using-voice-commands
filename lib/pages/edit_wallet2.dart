...
class EditWallet2 extends StatefulWidget{

  Transwall _listener;
  Wallet _wallet;
  EditWallet2(this._listener, this._wallet);


  @override
  State<StatefulWidget> createState() {
    return _EditWalletState2();
  }

}

class _EditWalletState2 extends State<EditWallet2>{
